...
namespace ConsoleApp.CommandLine.Tests
{
	public class CommandLineTests
	{
		...
		{
			deniszykov.CommandLine.CommandLine.UnhandledException += (sender, args) => output.WriteLine(args.Exception.ToString());
			deniszykov.CommandLine.CommandLine.DescribeOnBindFailure = false;

			var exitCode = deniszykov.CommandLine.CommandLine.Run<Api>(new CommandLineArguments(commandLineArguments), method);
